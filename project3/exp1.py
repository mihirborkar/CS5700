...
for rate in range(1, 11):
    ...
    str_latency = ''
    for var in TCP_Variant:
        str_throughput = str_throughput + '\t' + str(get_throughput(var, rate))
        str_droprate = str_droprate + '\t' + str(get_drop_rate(var, rate))
        str_latency = str_latency + '\t' + str(get_latency(var, rate))
